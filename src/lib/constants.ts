...
export const FILE_TRANSPORT_ACK_CHUNK_INTERVAL = 32;
export const FILE_TRANSPORT_ACK_MAX_INTERVAL_MS = 5000;
...
export const P2P_FILE_CHUNK_RATE_LIMIT = MAX_CHUNKS_PER_SECOND * 120;
